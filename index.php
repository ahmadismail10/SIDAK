...
<span style='padding-top:5px;'> <a href='<?php echo $scriptname?>'> SIDAK </a></span>
</div>

<span id=logo>
Sistem Informasi Data Komputer
</span>
...
<?php 
  ...
  echo "\n<form name=itdbloginfrm method=post>".
   "<input name=authusername placeholder='username' size=10 onfocus=\"this.value='';\" ".
   "value='$itdbuser'>\n<br>".
   "<input name=authpassword placeholder='password' size=10  type=password onfocus=\"this.value='';\" ".
   "value=''>\n".
...
echo "<br> <small>".
     "<a href='CHANGELOG.txt' class='ahdr'>Version $version</a><br><a style='color:white' href='http://ptpn10.co.id/'>PTPN X</a></small>\n";
?>
</div>
<!-- END OF #leftcolumn -->
